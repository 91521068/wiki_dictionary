...
class QuotesSpider(scrapy.Spider):
    ...
    c3s = [
        ...
        'legal',
        'broadcasting',
        'comprehensive enginnering terms',
        ...
        'blogging',
        'automotive design',
        'aviation, aerospace, and aeronautics',
        'nautical',
        'rail transport',
    ...
    def parse(self, response):
        ...
        index = self.find_index(response.url)
        c1 = self.c1s[index]
        c2 = self.c2s[index]
        c3 = self.c3s[index]
